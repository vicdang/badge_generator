...
class ImageNameVerifier:
    ...
    def __init__(self, args):
        ...
        self.pattern = r'^[^\s_]+ [\w\s\u00C0-\u017F]+_(T|B)?\d{6}_(E|SE|TL|PM|SM|ASM|SME|A|SA|D|SD|VP)_[1-3]\.(png|jpg|bmp|jpeg)$'
    ...
    def setup_logger(self):
        ...
        # File handler
        file_handler = logging.FileHandler(self.log_file, encoding='utf-8')  # Specify encoding
...
def parse_arguments():
    ...
    parser.add_argument('-f', '--folder-path', dest='folder_path', type=str, default="./mock_images", nargs='?', help='Path to the folder containing images')
